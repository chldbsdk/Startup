...
<li class="topli"><a href="#" onclick="location.href='http://localhost:8283/login'"><img src="resources/img/logo.png"  width="100" height="100"></a></li>
<li class="topli"><a href=#>오시는 길</a></li>
